...
if __name__ == "__main__":
    ...
    window = Tk()
    window.title("Preprocesamiento y filtrado")

    button = Button(window, 
                    text="Generar RI sintetizado", 
                    command=gen_plot_ir, 
                    font=("Arial", 16),
                    fg="blue")
    button2 = Button(window, 
                    text="Reproducir RI sintetizado", 
                    command=play_sint_ir, 
                    font=("Arial", 16),
                    fg="blue")
    button3 = Button(window, 
                    text="Generar Ri a partir de datos grabados", 
                    command=ri_rec, 
                    font=("Arial", 16),
                    fg="blue")
    button4 = Button(window, 
                    text="Aplicar filtro IEC a RI y graficar en frecuencias la banda de 2000 Hz", 
                    command=fil_iec, 
                    font=("Arial", 16),
                    fg="blue")
